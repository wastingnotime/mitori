...
var transitionActions = []TaskAction{
	...
	{ID: "move_doing_halt", Label: "halt", Shortcut: "m", Kind: ActionMove, From: LaneDoing, To: LaneHalt, Class: TransitionNormal},
	{ID: "move_halt_doing", Label: "doing", Shortcut: "m", Kind: ActionMove, From: LaneHalt, To: LaneDoing, Class: TransitionNormal},
	...
	{ID: "move_doing_done", Label: "done", Shortcut: "d", Kind: ActionMove, From: LaneDoing, To: LaneDone, Class: TransitionNormal},
	{ID: "move_done_archived", Label: "archive", Shortcut: "x", Kind: ActionMove, From: LaneDone, To: LaneArchived, Class: TransitionNormal},
	...
	{ID: "move_done_doing", Label: "doing", Shortcut: "m", Kind: ActionMove, From: LaneDone, To: LaneDoing, Class: TransitionRecovery, RequiresConfirmation: true},
	{ID: "move_archived_done", Label: "restore done", Shortcut: "d", Kind: ActionMove, From: LaneArchived, To: LaneDone, Class: TransitionRecovery, RequiresConfirmation: true},
	{ID: "move_archived_backlog", Label: "restore backlog", Shortcut: "b", Kind: ActionMove, From: LaneArchived, To: LaneBacklog, Class: TransitionRecovery, RequiresConfirmation: true},
}
